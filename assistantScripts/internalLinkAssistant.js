...
(function () {
  ...
  GM_addStyle(`
    ...
    /* Queue indicator dot on toggle button */
    #bali-queue-dot {
      position:absolute; top:4px; right:4px;
      width:16px; height:16px; border-radius:50%;
      background:#ff3b4d; border:2px solid #0b0b0c;
      font-size:9px; font-weight:800; color:#fff;
      display:none; align-items:center; justify-content:center;
      box-shadow:0 0 8px rgba(255,59,77,0.8);
      font-family:'Inter',system-ui,sans-serif;
      pointer-events:none;
      animation:bali-pulse 2s ease-in-out infinite;
    }
    #bali-queue-dot.active { display:flex; }
    @keyframes bali-pulse {
      0%,100%{box-shadow:0 0 6px rgba(255,59,77,0.7);}
      50%{box-shadow:0 0 14px rgba(255,59,77,1);}
    }
    ...
    #bali-panel {
      ...
      height:680px; max-height:96vh;
      border:1px solid rgba(255,59,77,0.45);
      border-radius:14px; font-family:'Inter',system-ui,sans-serif;
      box-shadow:0 0 40px rgba(255,59,77,0.22), 0 16px 56px rgba(0,0,0,0.9);
      display:none; flex-direction:column;
      overflow:hidden;
      animation:bali-in 0.22s ease forwards;
      background-image:
        radial-gradient(circle at 18% 18%, rgba(255,59,77,0.2), transparent 50%),
        radial-gradient(circle at 84% 8%, rgba(155,20,35,0.18), transparent 46%),
        linear-gradient(145deg, #060607 0%, #0d0d0f 48%, #141416 100%);
    ...
    #bali-header {
      background:rgba(0,0,0,0.6); padding:14px 20px; flex-shrink:0;
      display:flex; align-items:center; justify-content:space-between;
      border-bottom:1px solid rgba(255,59,77,0.35);
    }
    #bali-header-left { display:flex; align-items:center; gap:12px; }
    #bali-header h2 { margin:0; font-size:14px; font-weight:800; color:#ffe9ec; letter-spacing:2px; text-transform:uppercase; text-shadow:0 0 10px rgba(255,59,77,0.55); }
    #bali-ver-badge { font-size:10px; color:rgba(255,180,190,0.7); background:rgba(255,59,77,0.12); border:1px solid rgba(255,59,77,0.25); border-radius:4px; padding:2px 7px; font-weight:600; }
    #bali-header-right { display:flex; align-items:center; gap:10px; }
    #bali-entry-count { font-size:12px; color:#ffd2d8; font-weight:600; }
    #bali-queue-warn {
      display:none; font-size:11px; color:#ffe0a0; background:rgba(255,200,50,0.12);
      border:1px solid rgba(255,200,50,0.35); border-radius:5px; padding:3px 8px; font-weight:600;
    }
    #bali-queue-warn.active { display:inline-flex; align-items:center; gap:4px; }

    #bali-body {
      overflow-y:auto; padding:16px 18px 0; display:flex;
    ...
    .bali-label {
      ...
      color:#ffd8dd; margin-bottom:6px; display:block;
      font-weight:800; text-shadow:0 0 6px rgba(255,59,77,0.4);
    }
    .bali-input {
      width:100%; background:rgba(5,5,5,0.75); border:1px solid rgba(255,59,77,0.3);
      border-radius:8px; color:#fff4f5; font-family:'Inter',system-ui,sans-serif;
      font-size:13.5px; padding:10px 13px; box-sizing:border-box;
      transition:border-color 0.2s, box-shadow 0.2s; outline:none;
      font-weight:500;
    }
    .bali-input:focus { border-color:#ff3b4d; box-shadow:0 0 12px rgba(255,59,77,0.3); }
    .bali-input::placeholder { color:rgba(255,210,216,0.38); }
    .bali-row { display:flex; gap:10px; align-items:stretch; }
    .bali-row .bali-input { flex:1; }

    /* Brand quick-select */
    #bali-brand-section { display:flex; flex-direction:column; gap:8px; }
    #bali-brand-search {
      width:100%; box-sizing:border-box;
      background:rgba(5,5,5,0.75); border:1px solid rgba(255,59,77,0.3); border-radius:8px;
      color:#fff4f5; font-size:13px; padding:9px 13px; font-weight:500;
      outline:none; font-family:'Inter',system-ui,sans-serif;
      transition:border-color 0.2s, box-shadow 0.2s;
    }
    #bali-brand-search:focus { border-color:#ff3b4d; box-shadow:0 0 12px rgba(255,59,77,0.3); }
    #bali-brand-search::placeholder { color:rgba(255,210,216,0.38); }
    #bali-brand-buttons {
    ...
    .b-brand-btn {
      background:rgba(18,18,20,0.92); border:1px solid rgba(255,59,77,0.3); color:#ffe9ec;
      font-size:12px; padding:5px 11px; border-radius:6px; cursor:pointer;
      transition:background 0.15s, border-color 0.15s, transform 0.1s;
      white-space:nowrap; font-family:'Inter',system-ui,sans-serif; font-weight:500;
    }
    .b-brand-btn:hover { background:rgba(255,59,77,0.16); border-color:#ff3b4d; color:#fff; transform:scale(1.03); box-shadow:0 0 8px rgba(255,59,77,0.3); }
    ...
    #bali-options {
      ...
      background:rgba(8,8,8,0.74); padding:8px 14px; border-radius:8px; border:1px solid rgba(255,59,77,0.2);
    }
    .bali-checkbox-label {
      display:flex; align-items:center; gap:6px;
      font-size:12.5px; color:#ffd9de; cursor:pointer; user-select:none;
      font-weight:600;
    }
    .bali-checkbox-label input[type=checkbox] { accent-color:#ff3b4d; width:14px; height:14px; }
    ...
    .bali-entry {
      ...
      background:rgba(10,10,12,0.82); border:1px solid rgba(255,59,77,0.22);
      border-radius:8px; padding:9px 13px;
    }
    .bali-entry-text { font-size:12.5px; color:#ffe9ec; font-weight:700; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
    .bali-entry-url  { font-size:11.5px; color:rgba(255,202,209,0.75); overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
    .bali-remove-btn {
      background:none; border:1px solid rgba(255,59,77,0.55); color:#ffdbe0;
      border-radius:5px; cursor:pointer; font-size:12px;
      width:26px; height:26px; display:flex; align-items:center;
      justify-content:center; flex-shrink:0; transition:background 0.15s;
    }
    .bali-remove-btn:hover { background:rgba(255,59,77,0.22); }
    ...
    .bali-btn {
      ...
      border:none; transition:opacity 0.2s, transform 0.12s, box-shadow 0.2s; white-space:nowrap;
    }
    .bali-btn:hover { opacity:0.88; }
    .bali-btn:active { transform:scale(0.97); }
    #bali-add-btn   { background:rgba(18,18,20,0.9); color:#ffe9ec; border:1px solid rgba(255,59,77,0.5); box-shadow:0 0 8px rgba(255,59,77,0.18); }
    #bali-run-btn   { background:linear-gradient(180deg, #ff3b4d 0%, #d92b3b 100%); color:#fff; flex:1; box-shadow:0 0 16px rgba(255,59,77,0.38); }
    #bali-undo-btn  { background:rgba(18,18,20,0.9); color:#ffe9ec; border:1px solid rgba(255,59,77,0.42); }
    #bali-clear-btn { background:rgba(10,10,10,0.9); color:rgba(255,210,216,0.72); border:1px solid rgba(255,59,77,0.22); }

    #bali-status {
      font-size:12px; color:#ffe9ec; min-height:18px; font-weight:600;
      text-align:center; padding:9px 16px; flex-shrink:0;
      background:rgba(0,0,0,0.58);
    }
    #bali-status.ok   { color:#afffaf; text-shadow:0 0 8px rgba(100,255,100,0.65); }
    #bali-status.err  { color:#ffaaaa; text-shadow:0 0 8px rgba(255,100,100,0.65); }
    #bali-status.warn { color:#ffe0a0; text-shadow:0 0 8px rgba(255,200,50,0.65); }
    #bali-no-entries { font-size:12.5px; color:rgba(255,210,216,0.7); font-weight:600; text-align:center; padding:12px 0; }
    #bali-no-brands  { font-size:12.5px; color:rgba(255,210,216,0.7); font-weight:600; text-align:center; padding:10px 0; width:100%; }

    /* Category quick-select */
    #bali-cat-section { display:flex; flex-direction:column; gap:8px; }
    #bali-cat-buttons { display:flex; flex-wrap:wrap; gap:6px; }
    .b-cat-btn {
      background:rgba(18,18,20,0.92); border:1px solid rgba(255,59,77,0.3); color:#ffe9ec;
    ...
    .b-cat-btn:hover { background:rgba(255,59,77,0.16); border-color:#ff3b4d; color:#fff; transform:scale(1.03); box-shadow:0 0 8px rgba(255,59,77,0.3); }
    ...
    .b-cat-btn.pcbuilder {
      background:rgba(233,69,96,0.22); border-color:rgba(233,69,96,0.75); color:#fff;
      font-weight:700; text-shadow:0 0 8px rgba(233,69,96,0.85);
      box-shadow:0 0 8px rgba(233,69,96,0.35);
    }
    .b-cat-btn.pcbuilder:hover { background:rgba(233,69,96,0.42); border-color:#e94560; box-shadow:0 0 14px rgba(233,69,96,0.65); }
    .b-cat-btn.pcbuilder.selected { background:rgba(233,69,96,0.48); border-color:#e94560; box-shadow:0 0 16px rgba(233,69,96,0.78); }

    /* PCB homepage button highlight */
    .b-cat-btn.pcb-home {
      background:rgba(255,255,255,0.13); border-color:rgba(255,255,255,0.75); color:#fff;
      font-weight:700; text-shadow:0 0 8px rgba(255,255,255,0.85);
      box-shadow:0 0 8px rgba(255,255,255,0.28);
    }
    .b-cat-btn.pcb-home:hover { background:rgba(255,255,255,0.28); border-color:#fff; box-shadow:0 0 14px rgba(255,255,255,0.55); }
    .b-cat-btn.pcb-home.selected { background:rgba(255,255,255,0.33); border-color:#fff; box-shadow:0 0 16px rgba(255,255,255,0.68); }

    /* ── Entry Edit Mode ───────────────────────────────────────────── */
    .bali-entry { display:grid; grid-template-columns:1fr 1.4fr auto auto auto; gap:8px; align-items:center; }
    .bali-entry.editing { grid-template-columns:1fr 1.4fr auto auto; }
    .bali-entry-edit-inp {
      background:rgba(5,5,5,0.82); border:1px solid rgba(255,59,77,0.55); border-radius:6px;
      color:#fff4f5; font-family:'Inter',system-ui,sans-serif; font-size:12px; padding:5px 9px;
      outline:none; width:100%; box-sizing:border-box;
      transition:border-color 0.18s, box-shadow 0.18s;
    }
    .bali-entry-edit-inp:focus { border-color:#ff3b4d; box-shadow:0 0 8px rgba(255,59,77,0.35); }
    .bali-entry-icon-btn {
      background:none; border:1px solid rgba(255,59,77,0.38); color:#ffd8dc;
      border-radius:5px; cursor:pointer; font-size:13px;
      width:26px; height:26px; display:flex; align-items:center;
      justify-content:center; flex-shrink:0; transition:background 0.15s, border-color 0.15s;
    }
    .bali-entry-icon-btn:hover { background:rgba(255,59,77,0.18); border-color:#ff3b4d; color:#fff; }
    .bali-entry-icon-btn.save { border-color:rgba(100,255,130,0.5); color:#afffaf; }
    .bali-entry-icon-btn.save:hover { background:rgba(80,200,100,0.15); border-color:#afffaf; }
    .bali-entry-icon-btn.tpl  { border-color:rgba(100,180,255,0.45); color:#a0d0ff; }
    .bali-entry-icon-btn.tpl:hover  { background:rgba(60,140,255,0.15); border-color:#7ab8ff; }

    /* ── Template Panel ───────────────────────────────────────────── */
    #bali-tpl-section { display:flex; flex-direction:column; gap:8px; }
    #bali-tpl-row { display:flex; gap:8px; align-items:center; }
    #bali-tpl-name {
      flex:1; background:rgba(5,5,5,0.75); border:1px solid rgba(255,59,77,0.3); border-radius:8px;
      color:#fff4f5; font-family:'Inter',system-ui,sans-serif; font-size:13px; padding:9px 13px;
      outline:none; transition:border-color 0.2s, box-shadow 0.2s; font-weight:500;
    }
    #bali-tpl-name:focus { border-color:#ff3b4d; box-shadow:0 0 12px rgba(255,59,77,0.3); }
    #bali-tpl-name::placeholder { color:rgba(255,210,216,0.38); }
    #bali-tpl-save-btn {
      background:rgba(18,18,20,0.9); color:#ffe9ec; border:1px solid rgba(255,59,77,0.45);
      border-radius:7px; padding:9px 14px; cursor:pointer; font-size:12px; font-weight:700;
      font-family:'Inter',system-ui,sans-serif; white-space:nowrap;
      transition:background 0.15s, box-shadow 0.15s;
    }
    #bali-tpl-save-btn:hover { background:rgba(255,59,77,0.18); box-shadow:0 0 8px rgba(255,59,77,0.3); }

    /* Template search */
    #bali-tpl-search {
      width:100%; box-sizing:border-box;
      background:rgba(5,5,5,0.75); border:1px solid rgba(255,59,77,0.28); border-radius:8px;
      color:#fff4f5; font-family:'Inter',system-ui,sans-serif; font-size:12.5px; padding:8px 13px;
      outline:none; transition:border-color 0.2s, box-shadow 0.2s; font-weight:500;
    }
    #bali-tpl-search:focus { border-color:#ff3b4d; box-shadow:0 0 10px rgba(255,59,77,0.25); }
    #bali-tpl-search::placeholder { color:rgba(255,210,216,0.35); }
    ...
    .bali-tpl-row {
      ...
      background:rgba(12,12,14,0.88); border:1px solid rgba(255,59,77,0.2);
      border-radius:7px; padding:7px 11px;
      transition:border-color 0.15s, background 0.15s;
    }
    .bali-tpl-row:hover { border-color:rgba(255,59,77,0.45); background:rgba(20,10,12,0.95); }
    .bali-tpl-row-name {
      font-size:12.5px; color:#ffe9ec; font-weight:700;
      overflow:hidden; text-overflow:ellipsis; white-space:nowrap;
    }
    .bali-tpl-row-count {
      font-size:10px; color:#ff3b4d; background:rgba(255,59,77,0.12);
      border:1px solid rgba(255,59,77,0.3); border-radius:4px;
      padding:1px 6px; font-weight:700; white-space:nowrap;
    }
    .bali-tpl-action {
      background:none; border:1px solid rgba(255,59,77,0.3); color:#ffd0d5;
      border-radius:5px; cursor:pointer; font-size:12px;
      width:26px; height:26px; display:flex; align-items:center;
      justify-content:center; flex-shrink:0; transition:background 0.15s, border-color 0.15s;
    }
    .bali-tpl-action:hover { background:rgba(255,59,77,0.18); border-color:#ff3b4d; color:#fff; }
    .bali-tpl-action.edit  { border-color:rgba(100,180,255,0.45); color:#a0d0ff; }
    .bali-tpl-action.edit:hover  { background:rgba(60,140,255,0.15); border-color:#7ab8ff; }
    ...
    #bali-tpl-editor {
      ...
      background:linear-gradient(160deg, #07070a 0%, #0f0f12 100%);
      border-radius:14px;
      display:none; flex-direction:column;
      animation:bali-slide-in 0.2s ease forwards;
    }
    #bali-tpl-editor.active { display:flex; }
    @keyframes bali-slide-in {
      from { opacity:0; transform:translateX(22px); }
      to   { opacity:1; transform:translateX(0); }
    }
    #bali-tpl-ed-header {
      display:flex; align-items:center; justify-content:space-between;
      padding:14px 20px; border-bottom:1px solid rgba(255,59,77,0.3);
      background:rgba(0,0,0,0.55); flex-shrink:0;
    }
    #bali-tpl-ed-title { font-size:13px; font-weight:800; color:#ffe9ec; letter-spacing:1.5px; text-transform:uppercase; }
    #bali-tpl-ed-actions { display:flex; gap:8px; }
    .bali-tpl-ed-btn {
      padding:7px 13px; border-radius:6px; cursor:pointer; font-size:12px; font-weight:700;
      font-family:'Inter',system-ui,sans-serif; transition:opacity 0.2s, transform 0.12s; border:none;
    }
    .bali-tpl-ed-btn:hover { opacity:0.85; }
    .bali-tpl-ed-btn:active { transform:scale(0.97); }
    #bali-tpl-ed-save-btn  { background:linear-gradient(180deg,#ff3b4d,#d92b3b); color:#fff; }
    #bali-tpl-ed-close-btn { background:rgba(18,18,20,0.9); color:#ffd0d5; border:1px solid rgba(255,59,77,0.35); }
    #bali-tpl-ed-body {
    ...
    .bali-tpl-ed-entry {
      display:grid; grid-template-columns:1fr 1.4fr auto;
      gap:8px; align-items:center;
      background:rgba(10,10,14,0.9); border:1px solid rgba(255,59,77,0.2);
      border-radius:8px; padding:9px 12px;
    }
    .bali-tpl-ed-inp {
      background:rgba(5,5,5,0.8); border:1px solid rgba(255,59,77,0.3); border-radius:6px;
      color:#fff4f5; font-family:'Inter',system-ui,sans-serif; font-size:12px; padding:6px 10px;
      outline:none; width:100%; box-sizing:border-box;
      transition:border-color 0.18s, box-shadow 0.18s;
    }
    .bali-tpl-ed-inp:focus { border-color:#ff3b4d; box-shadow:0 0 8px rgba(255,59,77,0.3); }
    .bali-tpl-ed-inp::placeholder { color:rgba(255,210,216,0.3); }
    #bali-tpl-ed-add-row {
      display:flex; gap:8px; align-items:center; padding:10px 18px;
      border-top:1px solid rgba(255,59,77,0.18); flex-shrink:0;
      background:rgba(0,0,0,0.4);
    }
    #bali-tpl-ed-add-text, #bali-tpl-ed-add-url {
      flex:1; background:rgba(5,5,5,0.8); border:1px solid rgba(255,59,77,0.28); border-radius:7px;
      color:#fff4f5; font-family:'Inter',system-ui,sans-serif; font-size:12.5px; padding:8px 12px;
      outline:none; transition:border-color 0.2s, box-shadow 0.2s;
    }
    #bali-tpl-ed-add-text:focus, #bali-tpl-ed-add-url:focus { border-color:#ff3b4d; box-shadow:0 0 8px rgba(255,59,77,0.25); }
    #bali-tpl-ed-add-text::placeholder, #bali-tpl-ed-add-url::placeholder { color:rgba(255,210,216,0.32); }
    #bali-tpl-ed-add-btn {
      background:rgba(18,18,20,0.9); color:#ffe9ec; border:1px solid rgba(255,59,77,0.5);
      border-radius:7px; padding:8px 14px; cursor:pointer; font-size:12px; font-weight:700;
      font-family:'Inter',system-ui,sans-serif; white-space:nowrap;
      transition:background 0.15s, box-shadow 0.15s;
    }
    #bali-tpl-ed-add-btn:hover { background:rgba(255,59,77,0.18); box-shadow:0 0 8px rgba(255,59,77,0.3); }
    #bali-tpl-ed-no-entries { font-size:12px; color:rgba(255,210,216,0.5); text-align:center; padding:20px 0; font-weight:500; }

    /* ── Stats Bar ────────────────────────────────────────────────── */
    #bali-stats-bar {
      display:flex; align-items:center; justify-content:space-between;
      background:rgba(4,4,5,0.82); border-top:1px solid rgba(255,59,77,0.2);
      padding:8px 18px; flex-shrink:0; gap:10px;
    }
    #bali-stats-left { display:flex; align-items:center; gap:12px; }
    .bali-stat-item {
      display:flex; align-items:center; gap:5px;
      font-size:11.5px; color:rgba(255,220,225,0.75); font-weight:600;
    }
    .bali-stat-val {
      font-size:13px; color:#ff3b4d; font-weight:800;
      text-shadow:0 0 8px rgba(255,59,77,0.55);
    }
    #bali-stats-right { display:flex; align-items:center; gap:7px; }
    .bali-stat-btn {
      background:rgba(18,18,20,0.9); border:1px solid rgba(255,59,77,0.3); color:#ffd8dc;
      border-radius:6px; padding:5px 11px; cursor:pointer; font-size:11.5px; font-weight:700;
      font-family:'Inter',system-ui,sans-serif;
      transition:background 0.15s, border-color 0.15s;
    }
    .bali-stat-btn:hover { background:rgba(255,59,77,0.18); border-color:#ff3b4d; color:#fff; }
    #bali-stats-reset-btn { border-color:rgba(255,100,50,0.35); color:rgba(255,160,140,0.85); }
    #bali-stats-reset-btn:hover { background:rgba(255,80,50,0.18); border-color:#ff6040; color:#ffc0b0; }
  `);

  // ── UI ──────────────────────────────────────────────────────────────────────
  const toggleWrap = document.createElement('div');
  toggleWrap.style.cssText = 'position:fixed;bottom:24px;right:24px;z-index:999999;width:80px;height:80px;';

  const toggle = document.createElement('button');
  toggle.id = 'bali-toggle-btn'; toggle.title = 'PCBStore Bulk Link Inserter (Alt+W)';
  toggle.innerHTML = `
  ...
  queueDot.id = 'bali-queue-dot';

  toggleWrap.appendChild(toggle);
  toggleWrap.appendChild(queueDot);
  ...
  panel.innerHTML = `
    <div id="bali-header">
      ...
      <div id="bali-header-right">
        ...
        <span id="bali-entry-count">0 links</span>
      </div>
    </div>
    ...
    <div id="bali-body">
      ...
      <!-- ── LINK QUEUE (top) ────────────────────────────────────── -->
      <div>
        <span class="bali-label">Link Queue <small style="font-size:10px;letter-spacing:0;opacity:0.6;text-transform:none;font-weight:500">— ✏ edit row  🗙 update template</small></span>
        <div id="bali-entries">
          <div id="bali-no-entries">No entries yet. Add anchor text + URL below.</div>
        </div>
      </div>
      ...
      <div class="bali-row">
        ...
        <button class="bali-btn" id="bali-clear-btn">✕ Clear Queue</button>
      </div>
      ...
      <!-- ── Add New Entry ────────────────────────────────────── -->
      <div>
        <span class="bali-label">Add to Queue</span>
        <input id="bali-text-input" class="bali-input" type="text" placeholder="Anchor text to find & link…" style="margin-bottom:8px">
        <div class="bali-row">
      ...
      <div id="bali-brand-section">
        <span class="bali-label">Quick URL Select — Brand / Category</span>
      ...
      <!-- ── Templates ─────────────────────────────────────────── -->
      <div id="bali-tpl-section" style="padding-bottom:16px">
        <span class="bali-label">Link Templates — Saved to Browser</span>
        <div id="bali-tpl-row">
          <input id="bali-tpl-name" type="text" placeholder="Template name (e.g. Keyboard Page)…">
          <button id="bali-tpl-save-btn">💾 Save Queue as Template</button>
        </div>
    ...
    <!-- Stats Bar -->
    <div id="bali-stats-bar">
      <div id="bali-stats-left">
        <div class="bali-stat-item">🔗 Total Links Inserted: <span class="bali-stat-val" id="bali-stat-total">0</span></div>
        <div class="bali-stat-item">📋 Sessions Run: <span class="bali-stat-val" id="bali-stat-runs">0</span></div>
      </div>
      <div id="bali-stats-right">
        <button class="bali-stat-btn" id="bali-stats-copy-btn">📄 Copy Stats</button>
        <button class="bali-stat-btn" id="bali-stats-reset-btn">🗑 Reset Stats</button>
      </div>
    </div>

    <!-- Template Editor Overlay -->
    <div id="bali-tpl-editor">
      <div id="bali-tpl-ed-header">
        <span id="bali-tpl-ed-title">Edit Template</span>
        <div id="bali-tpl-ed-actions">
          <button class="bali-tpl-ed-btn" id="bali-tpl-ed-save-btn">💾 Save Template</button>
          <button class="bali-tpl-ed-btn" id="bali-tpl-ed-close-btn">✕ Close</button>
        </div>
      </div>
      <div id="bali-tpl-ed-body"></div>
      <div id="bali-tpl-ed-add-row">
        <input id="bali-tpl-ed-add-text" type="text" placeholder="Anchor text…">
        <input id="bali-tpl-ed-add-url"  type="text" placeholder="https://…">
        <button id="bali-tpl-ed-add-btn">+ Add Row</button>
      </div>
    </div>
  `;
  ...
  // ── localStorage keys ───────────────────────────────────────────────────────
  const LS_TEMPLATES = 'bali_templates_v2';
  const LS_STATS = 'bali_stats_v2';

  // ── Stats helpers ────────────────────────────────────────────────────────────
  function loadStats() {
    try { return JSON.parse(localStorage.getItem(LS_STATS)) || { total: 0, runs: 0 }; }
    catch { return { total: 0, runs: 0 }; }
  }
  function saveStats(s) { localStorage.setItem(LS_STATS, JSON.stringify(s)); }
  function renderStats() {
    const s = loadStats();
    $('bali-stat-total').textContent = s.total;
    $('bali-stat-runs').textContent = s.runs;
  }
  ...
  function renderTemplates(filter) {
    if (filter === undefined && $('bali-tpl-search')) filter = $('bali-tpl-search').value.trim().toLowerCase();
    filter = filter || '';
    const tpls = loadTemplates();
    const listEl = $('bali-tpl-list');
    listEl.innerHTML = '';
    let names = Object.keys(tpls);
    if (filter) names = names.filter(n => n.toLowerCase().includes(filter));
    if (!names.length) {
      listEl.innerHTML = `<span id="bali-tpl-empty">${filter ? 'No templates match.' : 'No templates saved yet.'}</span>`;
      return;
    }
    names.forEach(name => {
      const rowEl = document.createElement('div'); rowEl.className = 'bali-tpl-row';
      ...
      loadBtn.addEventListener('click', () => {
        entries = [...tpls[name]]; renderEntries(); updateCount();
        setStatus(`Loaded "${name}" (${tpls[name].length} links).`, 'ok');
      });
      ...
      // ✏ Edit template
      const editBtn = document.createElement('button'); editBtn.className = 'bali-tpl-action edit'; editBtn.title = 'Edit template'; editBtn.textContent = '✏';
      editBtn.addEventListener('click', () => openTemplateEditor(name));

      // 🗑 Delete
      const delBtn = document.createElement('button'); delBtn.className = 'bali-tpl-action del'; delBtn.title = 'Delete template'; delBtn.textContent = '🗑';
      delBtn.addEventListener('click', () => {
        if (!confirm(`Delete template "${name}"?`)) return;
        const t = loadTemplates(); delete t[name]; saveTemplates(t); renderTemplates();
        setStatus(`Template "${name}" deleted.`, 'warn');
      });

      rowEl.append(nameEl, countEl, loadBtn, mergeBtn, editBtn, delBtn);
  ...
  function updateQueueIndicator() {
    ...
    queueDot.classList.toggle('active', hasItems);
    queueDot.textContent = hasItems ? entries.length : '';
    $('bali-queue-warn').classList.toggle('active', hasItems);
  }
  ...
  function updateCount() {
    $('bali-entry-count').textContent = `${entries.length} link${entries.length === 1 ? '' : 's'} queued`;
    updateQueueIndicator();
  }
  function renderEntries() {
    const c = $('bali-entries'); c.innerHTML = '';
    if (!entries.length) { c.innerHTML = '<div id="bali-no-entries">No entries yet. Add anchor text + URL below.</div>'; return; }
    entries.forEach((e, i) => {
      const row = document.createElement('div'); row.className = 'bali-entry';
      row.innerHTML = `
        <span class="bali-entry-text" title="${e.text}">${escH(e.text)}</span>
        <span class="bali-entry-url"  title="${e.url}">${escH(e.url)}</span>
        <button class="bali-entry-icon-btn" data-i="${i}" title="Edit (temporary)">✏️</button>
        <button class="bali-entry-icon-btn tpl" data-i="${i}" title="Update in a saved template">🗙</button>
        <button class="bali-entry-icon-btn" style="border-color:rgba(255,59,77,0.55)" data-i="${i}" title="Remove">✕</button>`;
      c.appendChild(row);

      // pencil — inline temp edit
      row.querySelectorAll('.bali-entry-icon-btn')[0].addEventListener('click', () => startInlineEdit(row, i));

      // grid icon — copy this entry's text+url back into a template
      row.querySelectorAll('.bali-entry-icon-btn')[1].addEventListener('click', () => {
        ...
        // find same anchor text and update URL, or push new
        const arr = tpls[name];
        const found = arr.findIndex(x => x.text === e.text);
        if (found >= 0) arr[found] = { text: e.text, url: e.url };
        else arr.push({ text: e.text, url: e.url });
        saveTemplates(tpls); renderTemplates();
        setStatus(`Entry saved to template "${name}".`, 'ok');
      });

      // remove
      row.querySelectorAll('.bali-entry-icon-btn')[2].addEventListener('click', () => {
        entries.splice(i, 1); renderEntries(); updateCount();
      });
    });
  }
  ...
  function startInlineEdit(row, i) {
    ...
    row.innerHTML = `
      <input class="bali-entry-edit-inp" value="${escH(e.text)}" placeholder="Anchor text">
      <input class="bali-entry-edit-inp" value="${escH(e.url)}"  placeholder="URL">
      <button class="bali-entry-icon-btn save" title="Save edit">✓</button>
      <button class="bali-entry-icon-btn"      title="Cancel">✕</button>`;
    const [tInp, uInp, saveBtn, cancelBtn] = row.querySelectorAll('input, button');
    saveBtn.addEventListener('click', () => {
      const t = tInp.value.trim(), u = uInp.value.trim();
      if (!t || !u) { setStatus('Both fields required.', 'err'); return; }
      entries[i] = { text: t, url: u }; renderEntries(); updateCount();
      setStatus('Entry updated (session only).', 'ok');
    });
    cancelBtn.addEventListener('click', () => { renderEntries(); });
    tInp.focus();
  }

  // ── Init stats + templates ───────────────────────────────────────────────────
  renderStats();
  renderTemplates();
  ...
  // ── Template save ────────────────────────────────────────────────────────────
  $('bali-tpl-save-btn').addEventListener('click', () => {
    const name = $('bali-tpl-name').value.trim();
    if (!name) { setStatus('Enter a template name first.', 'err'); return; }
    if (!entries.length) { setStatus('Queue is empty — nothing to save.', 'err'); return; }
    const tpls = loadTemplates();
    tpls[name] = [...entries];
    saveTemplates(tpls);
    renderTemplates();
    $('bali-tpl-name').value = '';
    setStatus(`Template "${name}" saved (${entries.length} link${entries.length === 1 ? '' : 's'}).`, 'ok');
  });

  // ── Stats copy ──────────────────────────────────────────────────────────────
  $('bali-stats-copy-btn').addEventListener('click', () => {
    const s = loadStats();
    const text = `PCBStore Link Inserter Stats\nTotal Links Inserted: ${s.total}\nSessions Run: ${s.runs}`;
    navigator.clipboard.writeText(text).then(() => {
      setStatus('Stats copied to clipboard!', 'ok');
    }).catch(() => {
  ...
  // ── Stats reset ──────────────────────────────────────────────────────────────
  $('bali-stats-reset-btn').addEventListener('click', () => {
    if (!confirm('Reset all stats? This cannot be undone.')) return;
    saveStats({ total: 0, runs: 0 });
    renderStats();
    setStatus('Stats reset.', 'warn');
  });

  // ── Template search ─────────────────────────────────────────────────────────────
  $('bali-tpl-search').addEventListener('input', e => renderTemplates(e.target.value.trim().toLowerCase()));

  // ── Template Editor Overlay ──────────────────────────────────────────────────
  let editorName = null;  // which template is being edited
  let editorEntries = []; // working copy for the editor
  ...
  function renderEditorEntries() {
    const body = $('bali-tpl-ed-body'); body.innerHTML = '';
    if (!editorEntries.length) {
      body.innerHTML = '<div id="bali-tpl-ed-no-entries">No links in this template yet.</div>';
      return;
    }
  ...
  // Add row to template editor
  $('bali-tpl-ed-add-btn').addEventListener('click', () => {
    const t = $('bali-tpl-ed-add-text').value.trim();
    const u = $('bali-tpl-ed-add-url').value.trim();
    if (!t) { setStatus('Anchor text required.', 'err'); return; }
    if (!u || !/^https?:\/\//i.test(u)) { setStatus('Valid URL required.', 'err'); return; }
    editorEntries.push({ text: t, url: u });
    $('bali-tpl-ed-add-text').value = ''; $('bali-tpl-ed-add-url').value = '';
    renderEditorEntries();
    setStatus(`Row added to "${editorName}".`, 'ok');
  });

  [$('bali-tpl-ed-add-text'), $('bali-tpl-ed-add-url')].forEach(inp =>
    inp.addEventListener('keydown', e => { if (e.key === 'Enter') $('bali-tpl-ed-add-btn').click(); })
  );

  // Save template from editor
  $('bali-tpl-ed-save-btn').addEventListener('click', () => {
    if (!editorName) return;
    const tpls = loadTemplates();
    tpls[editorName] = editorEntries.filter(e => e.text.trim() && e.url.trim());
    saveTemplates(tpls); renderTemplates();
    $('bali-tpl-editor').classList.remove('active');
    setStatus(`Template "${editorName}" saved (${tpls[editorName].length} links).`, 'ok');
    editorName = null; editorEntries = [];
  });

  // Close editor without saving
  $('bali-tpl-ed-close-btn').addEventListener('click', () => {
    $('bali-tpl-editor').classList.remove('active');
    editorName = null; editorEntries = [];
